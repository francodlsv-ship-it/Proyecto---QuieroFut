...
Este es mi proyecto para el curso, llamado QuieroFut. Es un sitio web básico que armé sobre mi pasión por el fútbol, donde la idea principal es subir análisis de partidos y datos de este mundo.
